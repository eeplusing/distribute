 ...
 * 
 */
@WebServiceClient(name = "WarehouseService", targetNamespace = "http://server.ch9.corejava2.lixuan.com/", wsdlLocation = "http://localhost:8080/WebService/warehouse?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WAREHOUSESERVICE_QNAME = new QName("http://server.ch9.corejava2.lixuan.com/", "WarehouseService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebService/warehouse?wsdl");
    ...
    public Warehouse getWarehousePort() {
        return super.getPort(new QName("http://server.ch9.corejava2.lixuan.com/", "WarehousePort"), Warehouse.class);
    }
    ...
    public Warehouse getWarehousePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.ch9.corejava2.lixuan.com/", "WarehousePort"), Warehouse.class, features);
    }
