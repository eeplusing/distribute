...
public class Java01Level {
	public static void main(String[] args){
		...
		boolean isSplitTwoEqualArrays = Java01Level.isSplitTwoEqualArray(intArray);
	...
	public static boolean isSplitTwoEqualArray(int[]intArray){
		...
		for(Integer otherInt:otherInts){
			accumulationSum = Java01Level.expressionsAccumulation(accumulationSum,otherInt);
		}
